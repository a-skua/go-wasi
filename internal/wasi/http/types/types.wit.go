...
// Package types represents the imported interface "wasi:http/types@0.2.5".
package types

import (
	monotonicclock "github.com/a-skua/go-wasi/internal/wasi/clocks/monotonic-clock"
	ioerror "github.com/a-skua/go-wasi/internal/wasi/io/error"
	"github.com/a-skua/go-wasi/internal/wasi/io/poll"
	"github.com/a-skua/go-wasi/internal/wasi/io/streams"
	"go.bytecodealliance.org/cm"
)

// Duration represents the type alias "wasi:http/types@0.2.5#duration".
//
// See [monotonicclock.Duration] for more information.
type Duration = monotonicclock.Duration

// InputStream represents the imported type alias "wasi:http/types@0.2.5#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wasi:http/types@0.2.5#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// IOError represents the imported type alias "wasi:http/types@0.2.5#io-error".
//
// See [ioerror.Error] for more information.
type IOError = ioerror.Error

// Pollable represents the imported type alias "wasi:http/types@0.2.5#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// Method represents the variant "wasi:http/types@0.2.5#method".
//
//	variant method {
//		get,
//		head,
...
// Scheme represents the variant "wasi:http/types@0.2.5#scheme".
//
//	variant scheme {
//		HTTP,
//		HTTPS,
...
// DNSErrorPayload represents the record "wasi:http/types@0.2.5#DNS-error-payload".
//
...
// TLSAlertReceivedPayload represents the record "wasi:http/types@0.2.5#TLS-alert-received-payload".
//
...
// FieldSizePayload represents the record "wasi:http/types@0.2.5#field-size-payload".
//
...
// ErrorCode represents the variant "wasi:http/types@0.2.5#error-code".
//
//	variant error-code {
//		DNS-timeout,
...
// HeaderError represents the variant "wasi:http/types@0.2.5#header-error".
//
...
// FieldKey represents the string "wasi:http/types@0.2.5#field-key".
//
//	type field-key = string
type FieldKey string

// FieldName represents the type alias "wasi:http/types@0.2.5#field-name".
//
// See [FieldKey] for more information.
type FieldName = FieldKey

// FieldValue represents the list "wasi:http/types@0.2.5#field-value".
//
//	type field-value = list<u8>
type FieldValue cm.List[uint8]

// Fields represents the imported resource "wasi:http/types@0.2.5#fields".
//
//	resource fields
...
// Headers represents the imported type alias "wasi:http/types@0.2.5#headers".
//
// See [Fields] for more information.
type Headers = Fields

// Trailers represents the imported type alias "wasi:http/types@0.2.5#trailers".
//
// See [Fields] for more information.
type Trailers = Fields

// IncomingRequest represents the imported resource "wasi:http/types@0.2.5#incoming-request".
//
...
// OutgoingRequest represents the imported resource "wasi:http/types@0.2.5#outgoing-request".
//
...
// RequestOptions represents the imported resource "wasi:http/types@0.2.5#request-options".
//
...
// ResponseOutparam represents the imported resource "wasi:http/types@0.2.5#response-outparam".
//
...
// StatusCode represents the u16 "wasi:http/types@0.2.5#status-code".
//
//	type status-code = u16
type StatusCode uint16

// IncomingResponse represents the imported resource "wasi:http/types@0.2.5#incoming-response".
//
...
// IncomingBody represents the imported resource "wasi:http/types@0.2.5#incoming-body".
//
...
// FutureTrailers represents the imported resource "wasi:http/types@0.2.5#future-trailers".
//
...
// OutgoingResponse represents the imported resource "wasi:http/types@0.2.5#outgoing-response".
//
...
// OutgoingBody represents the imported resource "wasi:http/types@0.2.5#outgoing-body".
//
...
// FutureIncomingResponse represents the imported resource "wasi:http/types@0.2.5#future-incoming-response".
//
