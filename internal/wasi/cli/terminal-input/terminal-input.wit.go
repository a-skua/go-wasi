...
// Package terminalinput represents the imported interface "wasi:cli/terminal-input@0.2.5".
...
// TerminalInput represents the imported resource "wasi:cli/terminal-input@0.2.5#terminal-input".
//
