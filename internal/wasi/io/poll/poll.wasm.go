...
//go:wasmimport wasi:io/poll@0.2.5 [resource-drop]pollable
//go:noescape
func wasmimport_PollableResourceDrop(self0 uint32)

//go:wasmimport wasi:io/poll@0.2.5 [method]pollable.block
//go:noescape
func wasmimport_PollableBlock(self0 uint32)

//go:wasmimport wasi:io/poll@0.2.5 [method]pollable.ready
//go:noescape
func wasmimport_PollableReady(self0 uint32) (result0 uint32)

//go:wasmimport wasi:io/poll@0.2.5 poll
//go:noescape
