...
// Package udpcreatesocket represents the imported interface "wasi:sockets/udp-create-socket@0.2.5".
package udpcreatesocket

import (
	"github.com/a-skua/go-wasi/internal/gen/wasi/sockets/network"
	"github.com/a-skua/go-wasi/internal/gen/wasi/sockets/udp"
	"go.bytecodealliance.org/cm"
)

// Network represents the imported type alias "wasi:sockets/udp-create-socket@0.2.5#network".
//
// See [network.Network] for more information.
type Network = network.Network

// ErrorCode represents the type alias "wasi:sockets/udp-create-socket@0.2.5#error-code".
//
// See [network.ErrorCode] for more information.
type ErrorCode = network.ErrorCode

// IPAddressFamily represents the type alias "wasi:sockets/udp-create-socket@0.2.5#ip-address-family".
//
// See [network.IPAddressFamily] for more information.
type IPAddressFamily = network.IPAddressFamily

// UDPSocket represents the imported type alias "wasi:sockets/udp-create-socket@0.2.5#udp-socket".
//
