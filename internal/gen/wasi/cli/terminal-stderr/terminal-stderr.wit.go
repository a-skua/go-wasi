...
// Package terminalstderr represents the imported interface "wasi:cli/terminal-stderr@0.2.5".
...
// TerminalOutput represents the imported type alias "wasi:cli/terminal-stderr@0.2.5#terminal-output".
//
