...
// Package terminalstdin represents the imported interface "wasi:cli/terminal-stdin@0.2.5".
package terminalstdin

import (
	terminalinput "github.com/a-skua/go-wasi/internal/gen/wasi/cli/terminal-input"
	"go.bytecodealliance.org/cm"
)

// TerminalInput represents the imported type alias "wasi:cli/terminal-stdin@0.2.5#terminal-input".
//
