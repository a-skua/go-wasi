...
// Package terminalstdout represents the imported interface "wasi:cli/terminal-stdout@0.2.5".
package terminalstdout

import (
	terminaloutput "github.com/a-skua/go-wasi/internal/gen/wasi/cli/terminal-output"
	"go.bytecodealliance.org/cm"
)

// TerminalOutput represents the imported type alias "wasi:cli/terminal-stdout@0.2.5#terminal-output".
//
