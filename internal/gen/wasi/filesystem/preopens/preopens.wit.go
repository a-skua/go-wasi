...
// Package preopens represents the imported interface "wasi:filesystem/preopens@0.2.5".
package preopens

import (
	"github.com/a-skua/go-wasi/internal/gen/wasi/filesystem/types"
	"go.bytecodealliance.org/cm"
)

// Descriptor represents the imported type alias "wasi:filesystem/preopens@0.2.5#descriptor".
//
