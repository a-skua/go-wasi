...
// Package outgoinghandler represents the imported interface "wasi:http/outgoing-handler@0.2.5".
...
// OutgoingRequest represents the imported type alias "wasi:http/outgoing-handler@0.2.5#outgoing-request".
//
// See [types.OutgoingRequest] for more information.
type OutgoingRequest = types.OutgoingRequest

// RequestOptions represents the imported type alias "wasi:http/outgoing-handler@0.2.5#request-options".
//
// See [types.RequestOptions] for more information.
type RequestOptions = types.RequestOptions

// FutureIncomingResponse represents the imported type alias "wasi:http/outgoing-handler@0.2.5#future-incoming-response".
//
