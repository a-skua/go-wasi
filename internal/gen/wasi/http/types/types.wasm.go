...
//go:wasmimport wasi:http/types@0.2.5 [resource-drop]fields
//go:noescape
func wasmimport_FieldsResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [constructor]fields
//go:noescape
func wasmimport_NewFields() (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [static]fields.from-list
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.5 [method]fields.append
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.5 [method]outgoing-request.set-method
//go:noescape
func wasmimport_OutgoingRequestSetMethod(self0 uint32, method0 uint32, method1 *uint8, method2 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [method]outgoing-request.set-path-with-query
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.5 [method]outgoing-request.set-scheme
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.5 [method]response-outparam.send-informational
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.5 [resource-drop]incoming-response
//go:noescape
func wasmimport_IncomingResponseResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [method]incoming-response.consume
//go:noescape
func wasmimport_IncomingResponseConsume(self0 uint32, result *cm.Result[IncomingBody, IncomingBody, struct{}])

//go:wasmimport wasi:http/types@0.2.5 [method]incoming-response.headers
//go:noescape
func wasmimport_IncomingResponseHeaders(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [method]incoming-response.status
//go:noescape
func wasmimport_IncomingResponseStatus(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [resource-drop]incoming-body
//go:noescape
func wasmimport_IncomingBodyResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [static]incoming-body.finish
//go:noescape
func wasmimport_IncomingBodyFinish(this0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [method]incoming-body.stream
//go:noescape
func wasmimport_IncomingBodyStream(self0 uint32, result *cm.Result[InputStream, InputStream, struct{}])

//go:wasmimport wasi:http/types@0.2.5 [resource-drop]future-trailers
//go:noescape
func wasmimport_FutureTrailersResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [method]future-trailers.get
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.5 [method]future-trailers.subscribe
//go:noescape
func wasmimport_FutureTrailersSubscribe(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [resource-drop]outgoing-response
//go:noescape
func wasmimport_OutgoingResponseResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [constructor]outgoing-response
//go:noescape
func wasmimport_NewOutgoingResponse(headers0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [method]outgoing-response.body
//go:noescape
func wasmimport_OutgoingResponseBody(self0 uint32, result *cm.Result[OutgoingBody, OutgoingBody, struct{}])

//go:wasmimport wasi:http/types@0.2.5 [method]outgoing-response.headers
//go:noescape
func wasmimport_OutgoingResponseHeaders(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [method]outgoing-response.set-status-code
//go:noescape
func wasmimport_OutgoingResponseSetStatusCode(self0 uint32, statusCode0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [method]outgoing-response.status-code
//go:noescape
func wasmimport_OutgoingResponseStatusCode(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [resource-drop]outgoing-body
//go:noescape
func wasmimport_OutgoingBodyResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [static]outgoing-body.finish
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.5 [method]outgoing-body.write
//go:noescape
func wasmimport_OutgoingBodyWrite(self0 uint32, result *cm.Result[OutputStream, OutputStream, struct{}])

//go:wasmimport wasi:http/types@0.2.5 [resource-drop]future-incoming-response
//go:noescape
func wasmimport_FutureIncomingResponseResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.5 [method]future-incoming-response.get
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.5 [method]future-incoming-response.subscribe
//go:noescape
func wasmimport_FutureIncomingResponseSubscribe(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.5 http-error-code
//go:noescape
