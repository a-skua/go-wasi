...
type Fields[Self any, N ~FieldName, V FieldValue, E ~HeaderError] interface {
	ResourceDrop()
...
type IncomingRequest[
	S Scheme, M Method, H Fields[F, N, V, HE], B IncomingBody[I, SE, P],
	F any, N FieldName, V FieldValue, HE HeaderError,
...
type ResponseOutparam[
	Headers Fields[F, N, V, E], Err ErrorCode,
	F any, N FieldName, V FieldValue, E HeaderError,
] interface {
	ResourceDrop()
